...
<body id="page-top style="background-color: #fdf5f5 !important;">
        ...
        <nav class="navbar navbar-expand-lg bg-danger text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Treino+</a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-0">@treinomais</p>
                    </div>
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">SOBRE</h4>
                        <p class="lead mb-0">
                            Seu parceiro ideal para transformar sua saúde 
                            através de treinos eficientes e motivadores.
                        </p>
                    </div>
                </div>
            </div>
